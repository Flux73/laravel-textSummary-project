...
class TextController extends Controller
{
    ...
    public function summarizeText(Request $request) 
    {
        ...
        if (Auth::user()) {
            Text::create([
                'user_id' => Auth::id(),
                'text' => 'Morocco is a country located in North Africa, known for its rich history and cultural heritage. It has a diverse geography that ranges from the Atlantic and Mediterranean coasts to the rugged Atlas Mountains.',
                'text_summary' => 'Morocco is a country',
            ]);
        }

        return view('index', ['result' => 'Morocco is a country']); 
    }
}
